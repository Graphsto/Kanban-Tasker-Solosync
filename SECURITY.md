...
Report suspected problems through [Issues in this edition's GitHub repository](https://github.com/Graphsto/Kanban-Tasker-Solosync/issues).
Include the app version, Windows version, installation channel, a description of
the effect and reproduction steps using artificial data. Do not report issues to
the original author's repository for changes made in this edition.
