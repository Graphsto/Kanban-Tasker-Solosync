...
internal sealed partial class SetupWindow : Form
{
    ...
    public SetupWindow()
    {
        ...
        AutoScaleMode = AutoScaleMode.Dpi; ClientSize = new Size(590, 350); MinimumSize = new Size(530, 370);
    ...
    private async Task InstallAsync()
    {
        ...
        try
        {
            ...
            summary.Text = $"Kanban Tasker {payload.Metadata.Version} is installed.";
            details.Text = "Open Kanban Tasker from the Windows Start menu.\r\n\r\nYour existing data-file selection is kept. On first launch, choose Create data file or Open data file.";
            close.Text = "Finish";
            AcceptButton = close;
        }
